...
const sendEmail = async (email, subject, text) => {
  try {
    ...
    await transporter.sendMail({
      ...
      subject,
      text,
      html: `<head><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700;900&display=swap" rel="stylesheet"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"></head><html><body><div><img style="width:200px;margin:auto;display:flex" src="https://lh3.googleusercontent.com/pw/AP1GczPoBgFJXqvT8OLioV7101xVRica-lCpUmNP6zNgHN-iGnsO4ZbmnGvFe6dWU0Gp3C9YD9SsdUqYD7rgs1fQaMXtAAa4Ce-FUJjvhIOoWVMN0G4VQgJEOYUw2u4DZsQ1eE-RGBSMtDV3MqGxX0xZBBg=w2000-h1000"><div style="background-color:#eee7e7;display:grid;padding:50px;border-radius:20px;width:max-content;margin:auto;text-align:center"><p style="font-family:Roboto,sans-serif;font-weight:400;font-size:22px;margin:10px;color:#113231">Here is your password reset token, It expires in 1 hour</p><p style="font-family:Roboto,sans-serif;font-weight:900;font-size:45px;margin:10px;color:#113231;letter-spacing:10px">${text}</p></div></div></body></html>`,
    });
    return true;
  } catch (error) {
    return false;
